...
public class BusMain {
	...
	public static void main(String[] args) {
		...
		// individual item
		//Bus b1=new Bus(101, "Greyhound", 30, 5);
		...
		do {
			...
			System.out.println("3) Sort Bs By Name");
			...
			case 2: System.out.println("Sorting Buses By Id");
				// Collections.sort ties into the compareTo() method of Comparable interface
				Collections.sort(busList);
				printBuses(busList);
				break;
				
			case 3: System.out.println("Sorting Busses By Name(A-Z)");
				// 
				Collections.sort(busList, new BusNameComparator()); // class name
				printBuses(busList);
				break;
				
			case 4: System.out.println("Sorting By Fare(ASC)");
				// doing as a lambda expression
			...
			case 6:
				System.out.println("Thanks for using Search Bus App v1.0!!");
				break;
